...
# bombay-core: passing tests via nextest summary (summary is on stderr).
core_pass=$(cargo nextest run -p bombay-core --no-fail-fast 2>&1 \
...
# Sum the "test result: ok. N passed" line across all test binaries.
