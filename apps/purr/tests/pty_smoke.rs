...
//!
//! This test drives the *real* `purr --demo` binary through a pseudo-terminal,
...
/// A live `purr --demo` process attached to a PTY, with a background thread
...
impl TerminalSession {
    ...
    fn spawn_demo() -> Self {
        ...
        let mut cmd = CommandBuilder::new(env!("CARGO_BIN_EXE_purr"));
        cmd.arg("--demo");
